...
async def start_msg(client, message):
    await message.reply(f'''<b><i>Elite Bypass Bot!</i></b>
    
    <i>A Powerful Elegant Multi Threaded Bot written in Python... which can Bypass Various Shortener Links, Scrape links, and More ... </i>
    
    <i><b>Bot Started {convert_time(time() - BOT_START)} ago...</b></i>

🛃 <b>Use Me Here :</b> @eliteleechgroup <i>(Bypass Topic)</i>''',
        quote=True,
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('🎓 Dev', url='https://t.me/god_luffy_ati'), InlineKeyboardButton('🔍 Updates', url="https://t.me/elitecraft_studios")]
            ])
    )
...
🎛 <b>Inline Use :</b> !bp [Single Link]''',
                ...
                reply_markup=InlineKeyboardMarkup([
                        [InlineKeyboardButton("Bot Channel", url="https://t.me/elitecraft_studios"),
